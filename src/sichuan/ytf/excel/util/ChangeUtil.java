...
public class ChangeUtil {
	...
	public static String complexFormatChineseDate(java.util.Date _date) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append(calendar.get(Calendar.YEAR)).append("年").append(calendar.get(Calendar.MONTH) + 1).append("月")
				.append(Calendar.DAY_OF_MONTH).append("日").append(Calendar.HOUR_OF_DAY).append("时")
				.append(Calendar.MINUTE).append("分").append(Calendar.SECOND).append("秒");
		calendar.clear();
		return sb.toString();
	}
	 ...
	 *            终止日期
	 * @return 相隔天数,
	 *         如果结果为正表示<b>_endDate</b>在<b>_startDate</b>之后；如果结果为负表示<b>_endDate</b>在<b>_startDate</b>之前；如果结果为0表示<b>_endDate</b>和<b>_startDate</b>是同一天。
	 */
