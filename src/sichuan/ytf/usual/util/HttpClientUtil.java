...
public class HttpClientUtil {
    private RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(300000)
     ...
     * @param fileLists 附件
     */
    public String sendHttpPost(String httpUrl, Map<String, String> maps, Map<String, File> fileLists) {
        HttpPost httpPost = new HttpPost(httpUrl);// 创建httpPost
...
//            httpClient = HttpClients.custom().setSSLHostnameVerifier(hostnameVerifier).build();
    ...
    public static void main(String[] args) {
    	...
    	String html = client.sendHttpGet("http://www.baidu.com");
