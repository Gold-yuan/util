...
//            System.out.println(line);
        ...
        System.out.println("en length" + en.split(",").length);
    }
    ...
    public static void init() {
        ...
        sbb.append(",enterpriseLegalPerson,pharmaceuticalLicenseNumber,validityStartDate,validityEndDate");
        sba.append(",生产地址及范围,信用等级,质量受权人备案时间,相关证照");
        sbb.append(",productAddressAndScope,creditRating,qualityAuthorizedPersonFilingTime,relevantCertificates");
        sba.append(",中文地址,英文企业名称,中文认证范围,中文企业名称,英文认证范围");
        sbb.append(",chineseAddress,enterpriseNameEn,certificationScopeCn,enterpriseNameCn,certificationScopeEn");
        sba.append(",企业住所,许可证项目,使用科室,使用类别,单位负责人,许可证证号");
        sbb.append(",enterpriseResidence,licenseProject,useDepartment,useCategory,unitLeader,licenseNumber");
        sba.append(",电信业务经营许可证（非经营性互联网信息服务备案编号）,法定代表人（主要负责人）");
        sbb.append(",telecomBusinessLicense,legalRepresentative");
        sba.append(",经营者,名称,配置地址和配置范围");
        sbb.append(",operator,enterpriseName,configAddressAndScope");
        ...
        sba.append(",企业名称（英文）,认证范围（英文）,规格、型号");
        sbb.append(",enterpriseNameEn,authorityScopeEn,specificationOrModel");
        sba.append(",生产地址与生产范围,配制地址与配置范围,公示日期");
        sbb.append(",productionAddressAndScope,configAddressAndscope,announcementDate");
        ...
        sbb.append(
                ",equipmentName,applicantUnit,transmittingPower,occupiedbBandwidth,equipmentType,frequencyTolerance,frequencyRange,miscellaneousEmissionLimitation,approvalCertificateNumber");
        ...
        sbb.append(
                ",pharmaceuticalPackageName,useEnterpry,useEnterpryArea,productQualityStandardName,registrationNumber");
        ...
        sbb.append(
                ",commodityName,chineseSpelling,trademark,expirationDate,efficacyIngredients,suitablePeople,storageMethod,mattersNeedingAttention,usageDosage");
        ...
        sbb.append(
                ",productionEnterpriseName,quasiProductionRegistrationCertificateNumber,firstReregistration,reregistrationVarietiesOriginalRegistrationCertificateNumber");
        ...
        sbb.append(
                ",registrationCertificateNumber,smallWorkshopName,productVariety,registrationDate,registrationAuthority");
        ...
        sbb.append(
                ",chinesePinyin,englishNameOrLatinName,usedName,formerApprovalUnit,registrationClassification,packaging,validityPeriodApprovalNumber,packagingLabel,pharmaceuticalInstructions");
        sba.append(",生产国（地区）,生产企业（中文）,生产企业（英文）,在华申报责任单位,在华责任单位地址");
        sbb.append(
                ",productCountry,productionEnterpriseCn,productionEnterpriseEn,chinaDeclareResponsibleUnits,ChinaResponsibleUnitsAddress");
        sba.append(",生产企业地址,批件状态,批件有效期,卫生许可证号,产品名称备注,产品技术要求");
        sbb.append(
                ",productionEnterprisesAddress,batchStatu,batchvValidityPeriodDate,hygieneLicenseNumber,productNameAnnotation,productsTechnicalRequirement");
        ...
        sbb.append(
                ",productNameOrProductTypeName,modelSpecificationOrPackageSpecification,productDescriptionOrMainComponents");
        ...
        sbb.append(
                ",modelSpecification,structureComposition,applicationScope,productStandard,zipCode,mainComponents,expectedUse,storageConditionsAndExpiryDate");
        sba.append(",保护品种编号,药品名称,公告号,保护级别,保护起始日,保护终止日,保护期限");
        sbb.append(
                ",protectionSpeciesNumber,drugName,bulletinNumber,protectionLevel,protectionStartDate,protectionTerminationDate,protectionPeriod");
        sba.append(",品种名称,产品来源,法人代表");
        sbb.append(",varietiesName,productSource,corporater");
        sba.append(",省市,批准延续日期,有效期延续至,批准延续的认证范围,认证GMP版本");
        sbb.append(
                ",provinces,approvalExtensionDate,validityPeriodExtendDate,approvalExtensionCertificationScope,certificationGMPVersion");
        sba.append(",社会信用代码/组织机构代码");
        sbb.append(",socialCreditCodeOrOrganizationalCode");
        sba.append(
                ",原注册证号,注册证号备注,分包装批准文号,公司名称（中文）,公司名称（英文）,地址（中文）,地址（英文）,国家/地区（中文）,国家/地区（英文）,产品名称（中文）,产品名称（英文）,商品名（中文）,商品名（英文）,"
                        + "剂型（中文）,规格（中文）,包装规格（中文）,生产厂商（中文）,生产厂商（英文）,厂商地址（中文）,厂商地址（英文）,厂商国家/地区（中文）,厂商国家/地区（英文）,"
                        + "有效期截止日,分包装企业名称,分包装企业地址,分包装文号批准日期,分包装文号有效期截止日");
        sbb.append(
                ",originRegisterNumber,registerNumberNote,subpackageApprovalNumber,companyNameCn,companyNameEn,addressCn,addressEn,countryOrRegionCn,countryOrRegionEn,productNameCn,productNameEn,goodsNameCn,goodsNameEn,"
        ...
        sbb.append(
                ",traditionalChineseMedicinePreparationsName,processingRoute,medicalInstitutionsRegistrationAddress");
        sba.append(",产品注册证号");
        sbb.append(",productRegisterNumber");
        sba.append(
                ",备案人名称(中文),备案人名称(原文),备案人名称(英文),代理人,代理人注册地址,产品名称中文,产品名称原文,产品名称英文,结构特征,分类编码,备案办理人,首次备案/备案变更/取消备案日期,状态,备案变更次数,备案类型,第一类医疗器械生产备案号,是否已列入生产备案凭证的产品列表");
        sbb.append(
                ",recordHolderNameCn,recordHolderName,recordHolderNameEn,agent,agentRegistrationAddress,productNameCn,productName,productNameEn,structuralCharacteristics,classificationCode,filingAgent,firstOrChangeOrCancelFilingDate,status,filingChangesCount,filingType,firstTypeMedicalDevicesProductionFilingNumber,productionFilingProductsDocuments");
        sba.append(",内部受理号,统一审批编码,受理日期,企业注册地址,生产场所地址,注册证到期日期,产品储存条件及有效期,申请类型,产品分类,变更日期,变更内容,变更备注");
        sbb.append(
                ",internalAcceptanceNumber,uniformApprovalCode,acceptanceDate,enterpriseRegistrationAddress,productionSiteAddress,registrationCertificateMaturityDate,productStorageConditionsValidityDate,applicationType,productClassification,changeDate,changeContent,changeNote");
        sba.append(",网站IP地址,服务器存放地址,非经营性互联网信息服务备案编号");
        sbb.append(",websiteIPAddress,serverStorageAddress,nonCommercialInternetInformationServiceRecordNumber");
        ...
        sbb.append(
                ",registeredAddressDistrict,registeredStreet,licenseName,licensingInstitution,certificateStatus,GSPCertificationPeriod");
        sba.append(",企业场所所在区,许可证(备案凭证)名称,许可证(备案凭证)编号,经营模式,监管分级,监管分类");
        sbb.append(
                ",enterpriseArea,licenseName,licenseNumber,operationMode,supervisionGrading,supervisionClassification");
        ...
        sbb.append(
                ",manufacturingEnterprise,number,batchNumber,license,contractNumber,exportEnterpriseName,exportEnterpriseAddress,countrySold,productionQuantity,enterpriseContactPerson");
        ...
        sbb.append(
                ",entrustedEnterprise,healthLicense,entrustedEnterpriseAddress,entrustedEnterpriseHealthLicenseNumber,dateSequenceNumber");
        sba.append(",附件");
        ...
        sbb.append(
                ",manufacturers,areasManufacturersLocated,productStandardNumber,productionLicenseNumber,origin,foodAdditives,eatingMethods,storageConditions,shelfLife,ingredients");
        ...
        sbb.append(
                ",registrationAddress,preparingAddress,legalRepresentative,preparatoryOfficer,medicalInstitutionCategory,preparingScope,licenseNumber");
        sba.append(",有效期自");
        sbb.append(",validityPeriodStart");
        sba.append(",注册号,批准日期,批准有效期,发证机关,产品中文名称,产品品种编码,规格型号,注册商名称,注册厂家,注册商区域,产品结构及组成,产品主要功能,产品标准编号");
        sbb.append(
                ",registrationNumber,approvalDate,approvalValidityPeriod,licensingAuthority,productChineseName,productVarietyCode,specificationModel,registererName,registeredManufacturer,registererArea,productStructurecomposition,productMainFunctions,productStandardNumber");
        ...
        sbb.append(
                ",areaName,licenseIssuingDate,licenseValidityDate,productionAddressScopeProduction,relevantDatabaseQuery,note");

        sba.append(
                ",注册证编号,注册人名称,注册人住所,代理人名称,代理人住所,型号、规格/包装规格,结构及组成/主要组成成分,适用范围/预期用途,产品储存条件及有效期(体外诊断试剂适用),其他内容,审批部门,批证日期,变更信息");
        sbb.append(
        ...
        sbb.append(
                ",enterpriseName,standardName,standardNumber,standardFilingNumber,filingTime,filingValidityPeriod,standardFullTextRevisionForm");
        ...
        sbb.append(
                ",warehouseAddress,modeOperation,businessScope,GSPCertificateNumber,GSPCertificationDate,GSPCertificateValidityPeriod");

        sba.append(",批准文号,制剂名称,配制单位所属辖区,制剂类别,剂型,规格,配制单位名称");
        sbb.append(
                ",approvalNumber,preparationName,jurisdictionPreparationUnit,categoryPreparation,dosageForm,specification,preparationUnitName");

        sba.append(",主要负责人,医疗器械质量安全管理人,办公场所,网站名称,网站域名,网络客户端应用程序名,现场检查结果");
        sbb.append(
                ",responsiblePerson,medicalDeviceQualitySafetyAdministrator,officeSpace,websiteName,websiteDomainName,networkClientApplicationName,onSiteInspectionResults");

        sba.append(",序号,备案号,备案药品生产企业名称,调剂毒性中药饮品片品种名称,备案有效期");
        sbb.append(
                ",serialNumber,recordNumber,recordDrugManufacturerName,varietyDispensingToxicChineseMedicineDrinkName,filingTime");
        sba.append(",许可项目");
        sbb.append(",licensingProject");
        sba.append(",经营场所或生产场所,医疗器械网络销售类型,医疗器械生产（经营）许可证或备案凭证编号,医疗器械网络交易服务第三方平台名称");
        sbb.append(
                ",businessPlaceOrProductionPlace,networkSalesMedicalDevicesType,numberLicenseOrRecordCertificateProductionMedicalDevices,thirdPartyPlatformName");
        ...
        sbb.append(
                ",recordFilingOrgans,namesBusinessLeaders,foodSafetyAdministratorName,businessScopeMethods,businessAddresses");
        ...
        System.out.println("词组长度：" + names.length);
        System.out.println("词组长度：" + nameEns.length);
