...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
        ...
        String key = "9e185f74d4fd4dae997300f99be09be7";
        String ciphertext = util.AESencode("1a4a8278984227e95abadb751928189ba5c45adf7516c3824ba6a308110f2f09", key);
        System.out.println("密文："+ciphertext);
        String originText = util.AESdecode(ciphertext, key);
    ...
    byte[] encrypt(byte[] data, String key) throws Exception {
        SecretKeySpec sks = new SecretKeySpec(key.getBytes(), SELECT_ALGORITHM);
